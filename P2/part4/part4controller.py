...
class Part4Controller(object):
    ...
    def _handle_PacketIn(self, event):
        ...
        # Get the port + src/dst ip addrs
        # I cant believe i read so much documentation for this my eyes
        port_in = event.port

        # Create an ethernet addr
        # Any addr should? work, default to AMOGUS for now
        # TODO: More tests, maybe make this a field?
        ...
        if packet.type == packet.ARP_TYPE and packet.payload.opcode == arp.REQUEST:
            ...
            # Unhanlded packet (not clickbait) (real?) (gone wrong)
