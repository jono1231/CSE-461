...
class Firewall(object):
    ...
    def __init__(self, connection):
        ...
        # Im not sure why but having msg1.match worked instead of of.ofp_match method
        msg1.match.nw_proto = 1     # ICMP
        msg1.match.dl_type = 0x0800 # ICMP
        ...
        msg2.match.dl_type = 0x0806 # ARP

        action2 = of.ofp_action_output(port = of.OFPP_FLOOD)
